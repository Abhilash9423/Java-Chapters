...
public class PayrollDialog
{
   public static void main(String[] args)
   {
      ...
      inputString= JOptionPane.showInputDialog("what the break required");
      breakTime = Integer.parseInt(inputString);
      ...
      JOptionPane.showMessageDialog(null, "Hello " + 
                    ...
                    grossPay);
      JOptionPane.showMessageDialog(null," break required" + breakTime);
      // End the program.
      System.exit(0);
   }
}